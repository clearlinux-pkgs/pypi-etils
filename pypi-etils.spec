...
Version  : 0.6.0
Release  : 1
URL      : https://files.pythonhosted.org/packages/60/9d/3fad42e8860f2ceff835680b779b878229bf1d5dedefc99a34a6ce35d1b0/etils-0.6.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/60/9d/3fad42e8860f2ceff835680b779b878229bf1d5dedefc99a34a6ce35d1b0/etils-0.6.0.tar.gz
...
%prep
%setup -q -n etils-0.6.0
cd %{_builddir}/etils-0.6.0
pushd ..
cp -a etils-0.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656515950
...
cp %{_builddir}/etils-0.6.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-etils/1128f8f91104ba9ef98d37eea6523a888dcfa5de
