...
Source0  : https://files.pythonhosted.org/packages/7f/f5/c93520360736e5ead36a36349a1010d483b64533ffce759e7d1eb443f70d/etils-1.8.0.tar.gz
...
%prep
%setup -q -n etils-1.8.0
cd %{_builddir}/etils-1.8.0
pushd ..
cp -a etils-1.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710872969
