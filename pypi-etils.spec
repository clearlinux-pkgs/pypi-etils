...
Source0  : https://files.pythonhosted.org/packages/85/28/8a4d0614a7864c1c703f848dedb69d2f532a623ffb0159e390c06ad20279/etils-1.11.0.tar.gz
...
%prep
%setup -q -n etils-1.11.0
cd %{_builddir}/etils-1.11.0
pushd ..
cp -a etils-1.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732735621
